...
class Movie():
    ...
    # the __init__ function accepts 4 variables in order to instantiate a movie
    ...
    # the show_trailer function opens the link to the movie which has been clicked by the user
